...
const stats = [
    { icon: Trophy, label: "Projects Completed", value: "3+", color: "text-amber-500", bg: "bg-amber-500/10" },
    { icon: Code2, label: "Technologies", value: "10+", color: "text-blue-500", bg: "bg-blue-500/10" },
    { icon: Zap, label: "Years Experience", value: "3+", color: "text-green-500", bg: "bg-green-500/10" },
