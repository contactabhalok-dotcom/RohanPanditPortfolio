...
import { Code2, Github, Linkedin, Mail, ArrowUp, ArrowRight, Heart, Phone } from "lucide-react"

export function Footer() {
    const currentYear = new Date().getFullYear()

    const socialLinks = [
        { icon: Github, href: "https://github.com/contactabhalok-dotcom", label: "GitHub" },
        { icon: Linkedin, href: "https://linkedin.com", label: "LinkedIn" },
        { icon: Phone, href: "https://wa.me/6290351365", label: "WhatsApp" },
        { icon: Mail, href: "mailto:rohanpandityy35@gmail.com", label: "Email" },
    ]
    ...
    const footerLinks = [
        ...
        { title: "Connect", links: [
            { name: "GitHub", href: "https://github.com/contactabhalok-dotcom", external: true },
            { name: "LinkedIn", href: "https://linkedin.com", external: true },
            { name: "WhatsApp", href: "https://wa.me/6290351365", external: true },
        ]},
    ]
            ...
            <div className="container relative py-16 md:py-24 px-4 md:px-6">
                <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    >
                        <Link href="/" className="flex items-center gap-3">
                            ...
                            <span className="font-bold text-2xl tracking-tight">Rohan Pandit</span>
                        </Link>
                ...
                >
                    <p className="text-sm text-muted-foreground text-center sm:text-left">
                        © {currentYear} Rohan Pandit. All rights reserved.
                    </p>
